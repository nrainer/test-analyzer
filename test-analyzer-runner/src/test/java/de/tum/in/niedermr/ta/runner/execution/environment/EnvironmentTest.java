...
public class EnvironmentTest implements EnvironmentConstants, FileSystemConstants {
	...
	public void testReplacePrefixedPathPart() {
		...
		assertEquals("C:\\a.txt", Environment.replacePrefixedPathPart("{X}/a.txt", "{X}/", "C:" + PATH_SEPARATOR_ALTERNATIVE));
	}
	...
	public void testPrefixClasspath() {
		...
		String expected = FOLDER_WORKING_AREA + "./a.jar" + CP_SEP + FOLDER_WORKING_AREA + "b.jar" + CP_SEP + FOLDER_WORKING_AREA + "c.jar" + CP_SEP;
