...
/**
 * Jar: simple-project-system.jar Multi-threaded: yes (4) Comments: different jars for mutating and testing, skip simple
 * setters and getters, presentation DB
 */
public class IntegrationTest4 extends AbstractSystemTest {
	...
	public void testSystemInternal() throws ConfigurationException, IOException {
		assertFileExists(MSG_PATH_TO_TEST_JAR_IS_INCORRECT, new File(getCommonFolderTestData() + JAR_SYSTEM));
		assertFileExists(MSG_PATH_TO_DEPENDENCY_IS_INCORRECT, new File(getCommonFolderTestData() + JAR_CORE));
