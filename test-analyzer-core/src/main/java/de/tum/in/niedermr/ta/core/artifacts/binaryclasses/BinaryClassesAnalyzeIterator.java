...
class BinaryClassesAnalyzeIterator extends AbstractBinaryClassesIterator<ICodeAnalyzeOperation>
		implements IArtifactAnalysisIterator {
	protected BinaryClassesAnalyzeIterator(String inputJarPath, IArtifactExceptionHandler exceptionHandler) {
